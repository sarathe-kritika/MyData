...
public class OrderManagementTest extends BaseAPITest {
	...
	public void test_ALM43676_CreateOrder() throws ParkarCoreCommonException {
		...
		Request request = createPayload(orderManagmentAPIObject, productName, quantity);
	...
	public void test_ALM43678_UpdateOrder() throws ParkarCoreCommonException {
		...
		orderManagmentAPIObject.orderId=orderId;
		Request request = updatePayLoad(orderManagmentAPIObject, Integer.parseInt(orderManagmentAPIObject.orderId), updateProductName, updateQuantity);
		APIResponse response = orderManagmentAPIObject.update(request);
	...
	public void test_ALM43679_DeleteOrder() throws ParkarCoreCommonException {
		...
		orderManagmentAPIObject.orderId=orderId;
		APIResponse response = orderManagmentAPIObject.delete();
	...
	private Request createPayload(OrderManagmentAPIObject orderManagmentAPIObject, String productName,
	...
	private Request updatePayLoad(OrderManagmentAPIObject orderManagmentAPIObject, int id, String productName,
			int quantity) throws ParkarCoreCommonException {
		@SuppressWarnings("unchecked")
