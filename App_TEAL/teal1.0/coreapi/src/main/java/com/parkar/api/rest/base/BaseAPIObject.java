...
public abstract class BaseAPIObject {
	...
	public void login(String userName, String password) {
		...
		apiDriver.GLOBAL_COOKIE = AuthN.doLogin(apiOps, userName, password, BaseAPITest.BASE_URI);
	}
	...
	protected String loadSchema(String schemaLocation) {
		String schema = configurator.getDirectoryParameter("root") + File.separator + "resource" + File.separator + schemaLocation;
		return schema;
	}
