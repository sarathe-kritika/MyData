...
public class ParkarSeleniumUtil {
	 ...
	 * @param timeout int
	 */
	public static void waitForElementToBeEnabled(WebDriver driver,
	 ...
	 * @param timeout int
	 */
	public static void waitForElementToBeDisabled(WebDriver driver,
			WebElement elt, int timeout) {
	 ...
	 * @param timeout int
	 */
	public static void waitForElementToBeDisappear(WebDriver driver,
			WebElement elt, int timeout) {
	 ...
	 *            WebDriver
	 */
	public static void waitForDocumentStateToBeComplete(WebDriver driver) {
	 ...
	 * @return WebElement
	 */
	public static WebElement visibilityOfElementLocated(WebDriver driver,
			By locator, int timeout) throws NoSuchMethodException,
			SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
		return (new WebDriverWait(driver, timeout))
	 ...
	 */
	public static Boolean waitUntilElementIsInvisible(WebDriver driver,
	 ...
	 */
	public static Object executeScript(WebDriver driver,
