...
public class UIAssertion extends ParkarSoftAssertion{

	final static Logger logger = Logger.getLogger(UIAssertion.class);
	 ...
	 */
	public UIAssertion(WebDriver webDriver){
	...
	public boolean verifyTrue(final boolean condition, final String stepDetail) {
		...
		try {
			...
			reporter.reportStep(StepStatus.FAIL, message , BasicPageSyncHelper.saveAsScreenShot(webDriver));
		}
