...
public class BaseElement implements IBaseElement {
	...
	public BaseElement(WebDriver driver, final WebElement element, String locatorKey, String locator,
			String navigation) {
	 ...
	 */
	public BaseElement(WebDriver driver, final IBaseElement element, String locatorKey, String locator,
			String navigation) {
	 ...
	 */
	@Override
	public void setText(CharSequence... text) throws ParkarCoreUIException {
		ParkarLogger.traceEnter();
	 ...
	 */
	@Override
	public void submit() throws ParkarCoreUIException {
		ParkarLogger.traceEnter();
	 ...
	 */
	@Override
	public Object executeScript(String javascriptToExecute, Object... parameters) throws ParkarCoreUIException {
		ParkarLogger.traceEnter();
	...
	public void hover(int xOffset, int yOffset) throws ParkarCoreUIException {
		...
		try {
			...
			try {
				...
				throw new ParkarCoreUIException(infoMsg, e1);
			}
		}
		ParkarLogger.traceLeave();
	}
	 ...
	 * @throws ParkarCoreUIException throw a ParkarCoreUIException: While creation of select element
	 */
	@Override
	public List<String> getAllOptions() throws ParkarCoreUIException {
		ParkarLogger.traceEnter();
	 ...
	 * @throws ParkarCoreUIException : ParkarCoreUIException will be thrown on operation failure
	 */
	@Override
	public void dragAndDrop(IBaseElement target) throws ParkarCoreUIException {
		ParkarLogger.traceEnter();
		if (!(target instanceof Proxy)) {
			throw new ParkarCoreUIException(
	 ...
	 *            The value to set
	 * 
	 * @exception ParkarCoreUIException throws a  ParkarCoreUIException
	 */
