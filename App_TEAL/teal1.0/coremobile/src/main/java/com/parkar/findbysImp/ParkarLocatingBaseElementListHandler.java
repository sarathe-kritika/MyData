...
public class ParkarLocatingBaseElementListHandler implements InvocationHandler{
	...
	public <T> ParkarLocatingBaseElementListHandler(Class<?> interfaceType, Class<?> classType, String locatorKey, ElementLocator locator, BaseMobilePage page) {
	...
	public Object invoke(Object object, Method method, Object[] objects) throws Throwable {
	    ...
	    Constructor<?> cons = classType.getConstructor(AppiumDriver.class,WebElement.class, String.class, String.class, String.class);
	    try {
