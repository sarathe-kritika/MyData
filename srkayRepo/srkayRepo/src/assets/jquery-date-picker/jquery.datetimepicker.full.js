	...
	$.fn.datetimepicker = function (opt, opt2) {
		...
		createDateTimePicker = function (input) {
			...
			datetimepicker
              ...
              specialDateWithDesc += '<span class="special-date-desc">'+d+' - '+description+'</span></br>';
              }

              start.setDate(d + 1);
						}
            if(specialDateWithDesc.length > 0){
              table += '</tbody></table><div class="special-dates-desc-panel">'+specialDateWithDesc+'</div>';
            }else{
              table += '</tbody></table>';
            }
